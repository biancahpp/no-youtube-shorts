...
**[No YouTube Shorts – Chrome Web Store](https://chromewebstore.google.com/detail/bdnkckapbmljgapghjeelhjdcgjedbcg)**

This works for Chrome, Edge, Brave, Opera, Vivaldi, and other Chromium-based browsers.

### Load locally (for development or other browsers)

**Chrome / Chromium-based browsers**

1. Clone or download this repository.
2. Open the browser's extensions page (e.g. Chrome: `chrome://extensions/`).
3. Turn on **Developer mode** (usually top right).
4. Click **Load unpacked** and select the folder that contains `manifest.json` and `content.js`.
5. Go to YouTube. Shorts thumbnails should disappear from the feed and from the sidebar; new ones are removed as they load while you scroll.
...
**Privacy policy:** [View our privacy policy](https://biancahpp.github.io/no-youtube-shorts/).
